...
public class WndScoreBreakdown extends Window {
	...
	public WndScoreBreakdown(){
		...
		if (Statistics.winMultiplier > 1) {
			pos = statSlot(this, Messages.get(this, "win_multiplier"), Messages.concat(Messages.decimalFormat("#.##", Statistics.winMultiplier), Messages.literal("x")), pos, false);
		}
		if (Statistics.chalMultiplier > 1) {
			pos = statSlot(this, Messages.get(this, "challenge_multiplier"), Messages.concat(Messages.decimalFormat("#.##", Statistics.chalMultiplier), Messages.literal("x")), pos, false);
		}
