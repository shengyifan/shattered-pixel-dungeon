...
public class Blandfruit extends Food {
	...
	public String desc() {
		if (potionAttrib== null) {
			...
			String desc = Messages.concat(Messages.get(this, "desc_cooked"), Messages.literal("\n\n"));
			if (potionAttrib instanceof PotionOfFrost
				|| potionAttrib instanceof PotionOfLiquidFlame
				|| potionAttrib instanceof PotionOfToxicGas
				|| potionAttrib instanceof PotionOfParalyticGas) {
				desc = Messages.concat(desc, Messages.get(this, "desc_throw"));
			} else {
				desc = Messages.concat(desc, Messages.get(this, "desc_eat"));
			}
			return desc;
		}
	}
