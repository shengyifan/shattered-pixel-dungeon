...
public class BeamingRay extends TargetedClericSpell {
	...
	@Override
	public String desc() {
		return Messages.concat(Messages.concat(Messages.get(this, "desc", 4*Dungeon.hero.pointsInTalent(Talent.BEAMING_RAY), 30 + 5*Dungeon.hero.pointsInTalent(Talent.BEAMING_RAY)), Messages.literal("\n\n")), Messages.get(this, "charge_cost", (int)chargeUse(Dungeon.hero)));
	}
