...
public class Sunray extends TargetedClericSpell {
	...
	public String desc() {
		...
		return Messages.concat(Messages.concat(Messages.get(this, "desc", min, max, dur), Messages.literal("\n\n")), Messages.get(this, "charge_cost", (int)chargeUse(Dungeon.hero)));
	}
	...
	protected void onTargetSelected(HolyTome tome, Hero hero, Integer target) {
		...
		hero.sprite.parent.add(
				new Beam.SunRay(hero.sprite.center(), DungeonTilemap.raisedTileCenterToWorld(aim.collisionPos)).observeDraw(hero.pos, aim.collisionPos));
		Sample.INSTANCE.play( Assets.Sounds.RAY );
