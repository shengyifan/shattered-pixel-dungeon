...
/** Strict protocol 7 envelope parsing; gameplay availability and argument semantics belong to the coordinator. */
public final class ControlRequest {
    ...
    /** Original, unmodified protocol 7 request for durable audit. */
    ...
    private ControlRequest(Map<String, Object> raw) {
        ...
        if(canonical==null) throw new ProtocolException("UNKNOWN_OPERATION", "Unknown protocol 7 operation: " + wireOp);
    ...
    private static int protocolVersion(Map<String, Object> raw) {
        ...
        if (!Long.valueOf(PROTOCOL_VERSION).equals(value))
            throw new ProtocolException("UNSUPPORTED_PROTOCOL", "Only v " + PROTOCOL_VERSION + " is supported");
