...
/** Strict protocol 8 envelope parsing; gameplay availability and argument semantics belong to the coordinator. */
public final class ControlRequest {
    ...
    /** Original, unmodified protocol 8 request for durable audit. */
    ...
    private ControlRequest(Map<String, Object> raw) {
        ...
        if(canonical==null) throw new ProtocolException("UNKNOWN_OPERATION", "Unknown protocol 8 operation: " + wireOp);
