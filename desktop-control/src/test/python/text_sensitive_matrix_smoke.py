#!/usr/bin/env python3
"""Deep protocol-7 text cases in independent processes and disposable profiles.
...
def run_worker(job_path):
    ...
    try:
        ...
        assert evidence.handshakes and evidence.source_checks > 0, "No protocol-7 source evidence was recorded"
