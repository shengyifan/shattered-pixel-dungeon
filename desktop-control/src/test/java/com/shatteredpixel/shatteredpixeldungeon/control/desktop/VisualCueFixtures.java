...
final class VisualCueFixtures {
    static boolean supports(String name) { return Arrays.asList("visual-red", "visual-goo", "visual-hidden", "visual-frozen").contains(name); }
    ...
    static void prepare(String name, Hero hero) throws Exception {
        ...
        } else if (name.equals("visual-hidden")) {
