...
本分支正在开发 `spdctl` 机器控制接口，当前为 **CLI.7.0.0 / 协议 7 / schema 10**。使用方式见 [CLI 文档](docs/cli.md)，本帧操作共享、UI/操作/背包记录模板及本次验证见 [CLI 7 实施与验收](docs/cli7-implementation.md)。[完整单帧 token 研究](docs/cli-complete-frame-token-study-20260920.md)和[可读性与无损响应审查](docs/cli-issues/2026-09-20-cli-6.1.0-readability-lossless.md)保留为历史依据，旧研究收益不代表当前协议实测结果。
