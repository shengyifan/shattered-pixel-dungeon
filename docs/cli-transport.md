...
> 本页为 CLI.2.1.0 历史记录；当前 CLI.7.0.0 的事件过滤、颜色和接口以[新版手册](cli-help.md)及[实施记录](cli7-implementation.md)为准，实际包验证见[当前重建记录](cli-rebuild-7.0.0-20260921.md)。原始 transport 格式仍为版本 1。
