...
原 [22 项基线 14/8](cli-p6-english-validation.md) 和 [确认修复 5/6](cli-p6-dialog-signatures.md) 保持不变，其中的原失败、原错误码和对应 profile 未被覆盖。逐项版本、构建、原始轨迹和实际效果见 [最终 JSON 索引](cli-p6-english-completion.json)。
