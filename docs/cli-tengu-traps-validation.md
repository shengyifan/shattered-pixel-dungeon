...
两例最终实机均在冻结运行时 `runtime-3b0830ec63244f5d8e5877fef2514fc9`、构建 `ea06531e9e6700bf1aa57023b15f3d51e9f1eb9127562fba41bd9c74a1f63022` 中完成。逐例 profile 和实际格子集合见 cli-tengu-traps-validation.json（历史 JSON 已删除，可查 Git 历史）。
