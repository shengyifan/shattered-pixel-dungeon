...
> 当前版本为 CLI.7.0.1 / 协议 7 / 审计 schema 10，详见 [CLI 7 实施记录](cli7-implementation.md)与[战斗视觉和可靠性修复](cli-combat-visuals.md)。[2026-09-21 清理重建记录](cli-rebuild-7.0.0-20260921.md)属于 CLI.7.0.0 的历史验收。以下内容均保留为历史批次记录，旧协议示例与 profile 规则不适用于新版。
