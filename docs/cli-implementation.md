...
| P6 | 通用玩法与复杂交互 | 22 个低频交互场景、长路径取消及布局重建已验证；特殊组合和实际深层探索继续验证 |
| P7 | 六职业、十二子职、十九护甲能力与完整 UI | 188 个隔离矩阵场景与补充回归通过；详见 cli-p7-validation.md，尚未覆盖任意组合 |
| P8 | 故障、保存、断流、包与性能 | 真实保存失败/恢复、12 个账本及11个游戏强杀、未捕获异常、包内启动失败/布局/中文路径和性能基线已通过；真实长局数据随P9补充 |
